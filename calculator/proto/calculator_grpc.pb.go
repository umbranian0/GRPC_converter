...
const (
	...
	Calculator_Mul_FullMethodName = "/Calculator/Mul"
...
func (c *calculatorClient) Mul(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, Calculator_Mul_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculatorClient) Div(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, Calculator_Div_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
